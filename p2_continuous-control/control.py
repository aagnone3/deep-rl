...
base_dir = 'p2_continuous-control'
env = UnityEnvironment(file_name='{}/Reacher_Linux_NoVis/Reacher.x86_64'.format(base_dir))
...
agent = Agent(base_dir + '/agents.pytorch', state_size=state_size, action_size=action_size, random_seed=2)
